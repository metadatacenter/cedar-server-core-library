...
public class ModelPaths {
  ...
  public static final String SCHEMA_DESCRIPTION =  "/" + ModelNodeNames.SCHEMA_DESCRIPTION;
  public static final String SCHEMA_NAME = "/" + ModelNodeNames.SCHEMA_NAME;
  public static final String SCHEMA_IDENTIFIER =  "/" + ModelNodeNames.SCHEMA_IDENTIFIER;
  ...
  public static final String AT_ID = "/" + ModelNodeNames.LD_ID;
}
