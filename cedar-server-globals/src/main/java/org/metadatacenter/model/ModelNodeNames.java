...
public class ModelNodeNames
{
  ...
  public static final String VALUE_CONSTRAINTS_DATE_TIME_TYPE = "dateTimeType";
  ...
  public static final Set<String> VALUE_CONSTRAINTS_KEYWORDS = Stream
    .of(VALUE_CONSTRAINTS_DATE_TYPE, VALUE_CONSTRAINTS_ONTOLOGIES, VALUE_CONSTRAINTS_VALUE_SETS,
      ...
      VALUE_CONSTRAINTS_NUMBER_TYPE, VALUE_CONSTRAINTS_UNIT_OF_MEASURE, VALUE_CONSTRAINTS_DATE_TIME_TYPE).collect(Collectors.toUnmodifiableSet());
