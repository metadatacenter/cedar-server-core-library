...
public enum CedarEnvironmentVariable {
  ...
  CEDAR_NCI_CADSR_FTP_HOST("CEDAR_NCI_CADSR_FTP_HOST"),
  CEDAR_NCI_CADSR_FTP_USER("CEDAR_NCI_CADSR_FTP_USER"),
  CEDAR_NCI_CADSR_FTP_PASSWORD("CEDAR_NCI_CADSR_FTP_PASSWORD"),
  CEDAR_NCI_CADSR_FTP_CDES_DIRECTORY("CEDAR_NCI_CADSR_FTP_CDES_DIRECTORY"),
